  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden md:w-1/2">
        ...
        >
          <Image
            className="relative object-contain h-auto mx-auto w-80 lg:w-105 sm:w-85 xl:w-120 z-12"
      ...
      <div className="absolute flex items-center p-2 border rounded-lg bottom-4 right-8 bg-background/90 z-16 border-zinc-300 dark:border-white/6">
        ...
        <span className="p-1 border rounded-md border-zinc-300 dark:border-white/6">
